...
print("Receita carregada:", {j: pyo.value(modelo.c_receita[j]) for j in modelo.J_tipos_de_floresta})
print("Tempo por manejo:", {(i,j): pyo.value(modelo.a_recursos_x_floresta[i,j]) for i in modelo.I_recursos for j in modelo.J_tipos_de_floresta})
print("Limite:", {i: pyo.value(modelo.lim_recurso[i]) for i in modelo.I_recursos})
...
#modelo.J_tipos_de_floresta
modelo.x_variaveis[0]()
modelo.x_variaveis[1]()
